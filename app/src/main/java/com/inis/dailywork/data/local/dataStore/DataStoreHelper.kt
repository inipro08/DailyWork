package com.inis.dailywork.data.local.dataStore
...
class DataStoreHelper @Inject constructor(@ApplicationContext private val context: Context) {
    ...
    private fun <T> getValue(transform: (preferences: Preferences) -> T): Flow<T> =
    ...
    // Write data
    suspend fun setTheme(theme: Int) = setValue {
        it[KEY_THEME] = theme
    }
    ...
    companion object {
        ...
        private val KEY_THEME = intPreferencesKey("THEME_STYLE")
    }
}